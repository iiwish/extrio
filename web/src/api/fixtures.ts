...
export const seedAiRuns: AiRunDetail[] = [
  {
    ...
    operationId: 'op_ai_shanghai_0901',
    collectorId: shanghaiCollector.id,
    collectorName: shanghaiCollector.name,
    sourceUrl: shanghaiCollector.sourceUrl,
    kind: 'rule_generation',
    trigger: 'regeneration',
    initiatedBy: 'user_mock_admin',
    status: 'succeeded',
    phase: 'completed',
    progress: 100,
    ...
    attemptCount: 1,
    modelSummary: { invocationCount: 2, promptTokens: 8420, completionTokens: 1910, totalTokens: 10330, estimatedCost: null },
    ...
    error: null,
    attempts: [{
      id: 'ai_attempt_shanghai_1',
      aiRunId: 'ai_run_shanghai_0901',
      attemptNo: 1,
      status: 'succeeded',
      startedAt: '2026-09-01T05:10:01Z',
      finishedAt: '2026-09-01T05:10:29Z',
      ...
      modelInvocations: [
        {
          id: 'model_call_shanghai_discover', aiRunId: 'ai_run_shanghai_0901', aiAttemptId: 'ai_attempt_shanghai_1',
          purpose: 'discover', provider: 'openai', model: 'gpt-5.3-mini', promptVersion: '1.0', status: 'succeeded',
          startedAt: '2026-09-01T05:10:05Z', finishedAt: '2026-09-01T05:10:14Z', durationMs: 9000,
          promptTokens: 3980, completionTokens: 760, totalTokens: 4740, estimatedCost: null,
          responseDigest: digest('shanghai:discover'), error: null,
        },
        {
          id: 'model_call_shanghai_compile', aiRunId: 'ai_run_shanghai_0901', aiAttemptId: 'ai_attempt_shanghai_1',
          purpose: 'compile', provider: 'openai', model: 'gpt-5.3-mini', promptVersion: '1.0', status: 'succeeded',
          startedAt: '2026-09-01T05:10:15Z', finishedAt: '2026-09-01T05:10:26Z', durationMs: 11000,
          promptTokens: 4440, completionTokens: 1150, totalTokens: 5590, estimatedCost: null,
          responseDigest: digest('shanghai:compile'), error: null,
        },
      ],
    }],
  },
  {
    id: 'ai_run_beijing_0901',
    operationId: 'op_ai_beijing_0901',
    collectorId: beijingCollector.id,
    collectorName: beijingCollector.name,
    sourceUrl: beijingCollector.sourceUrl,
    kind: 'rule_generation',
    ...
    attemptCount: 1,
    modelSummary: { invocationCount: 1, promptTokens: 3210, completionTokens: 680, totalTokens: 3890, estimatedCost: null },
    ...
    error: null,
    attempts: [{
      id: 'ai_attempt_beijing_1', aiRunId: 'ai_run_beijing_0901', attemptNo: 1, status: 'running',
      startedAt: '2026-09-01T05:20:01Z', finishedAt: null, durationMs: null, error: null, modelInvocations: [],
    }],
  },
]
